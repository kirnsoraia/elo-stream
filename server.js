...
// ===== CONFIGURAÇÕES =====
const FACEIT_API_KEY = "86e45708-a971-41c8-b71c-8d88d0e1a98b";
...
async function getPremier() {
  const res = await fetch(
    `https://api.steampowered.com/ISteamUserStats/GetUserStatsForGame/v2/?key=${STEAM_API_KEY}&appid=730&steamid=${STEAM_ID_64}`
  );
